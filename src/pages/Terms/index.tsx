...
const Terms: React.FC = () => {
  ...
  return (
    <div className="py-16 px-5 lg:px-20 md:px-20">
      <div className="font-semibold"> 
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Quosha.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Quosha, accessible from{" "}
              <a
                href="https://quosha-ink.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://quosha-ink.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: quosha@gmail.com</li>
        </ul>
      </div>
    </div>
  );
